    ...
    <div className="min-h-screen bg-bhagva-50">
      <div className="container mx-auto py-12 px-4 md:px-6">
        <div className="bg-white shadow-lg rounded-lg p-6 md:p-8">
          <h1 className="text-3xl font-bold text-bhagva-700 mb-6 border-b-2 border-bhagva-300 pb-4">
          ...
          <div className="prose max-w-none text-gray-800">
            ...
            <ol className="list-decimal pl-6 space-y-2">
              ...
              <li>
                Charitable trust does not accept cancellation requests for perishable items like flowers, eatables, etc.
                However, the refund / replacement can be made if the user establishes that the quality of the product
              ...
              <li>
                ...
                must bring it to the notice of our customer service within 1 days of receiving the product. The customer
              ...
              <li>
                In case of any refunds approved by Charitable trust, it will take 1 days for the refund to be processed
                to you.
              </li>
            </ol>
